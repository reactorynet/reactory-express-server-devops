# ---------------------------------------------------------------------------
# production / workload layer
#
# Requires environments/production/cluster to have been applied first.
#
# Structurally identical to staging/workload — same modules, same wiring, larger
# replica counts and longer metric retention. Anything that needs to differ
# beyond a variable value is a signal that staging has stopped being a faithful
# rehearsal.
#
