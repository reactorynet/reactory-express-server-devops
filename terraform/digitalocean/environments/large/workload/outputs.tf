...
output "mongodb_host" {
  description = "Managed MongoDB private hostname"
  value       = local.cluster.mongodb_host
}
...
output "opensearch_host" {
  description = "Managed OpenSearch private hostname"
  value       = local.cluster.opensearch_host
}
