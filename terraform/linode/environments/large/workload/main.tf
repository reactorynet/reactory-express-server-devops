# ---------------------------------------------------------------------------
# Linode / large / workload layer
#
# Requires linode/environments/large/cluster.
#
# PostgreSQL is a Linode Managed Database in its 3-node HA configuration.
#
# MongoDB, Valkey and Meilisearch are STILL PODS at this tier — Akamai's Managed
# Databases cover MySQL and PostgreSQL only. Single instances on block storage,
# with no managed failover or backup. That is the gap between this and the
# DigitalOcean or AWS large tiers, and no amount of configuration closes it.
#
